...
/**
 * The main game "loop", claeed when the script is first loaded
 * and after the user's answer has been processed
 */
function runGame(gameType){

    //Ryder answer boks felt ved load & sætter cursor i answer-obx
...
/**
 * Gets the operands (the numbers) and the opeator (plus, minus etc)
